...
4. Results: The analysis revealed an overall upward trend in knee flexion over time, with temporary setbacks often associated with increased pain. Clustering identified three main types of recovery days: high-progress days with exercise, intense rehabilitation days with higher pain, low-activity or regression days.
...
4. Conclusions: This project demonstrates how data science techniques can provide objective insight into a highly personal recovery process. By analyzing my own rehabilitation data, I applied clustering, outlier detection, association rule mining, and predictive modeling to real-world time-series data.
